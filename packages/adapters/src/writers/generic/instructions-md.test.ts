...
describe("InstructionsMdWriter", () => {
	...
	const generatedCopyNotice =
		"> IMPORTANT: Do not edit this file directly. Edit `OMNI.md` instead. This file is a generated copy of `OMNI.md` and is ephemeral. Any persistent change must be made in `OMNI.md`.";
	...
	test("does not append anything when instructionsContent is empty", async () => {
		...
		const content = readFileSync(`${testDir.path}/CLAUDE.md`, "utf-8");
		expect(content).toBe(`${generatedCopyNotice}\n\n# Project Instructions\n\nBase content here.`);
	});
	...
	test("creates parent directories for nested output path", async () => {
		...
		expect(content).not.toContain(generatedCopyNotice);
